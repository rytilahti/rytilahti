...
and also written 5,647 issue comments here since 2013.
Since then, my projects have been honored with a total of 6,333 ⭐ and 1,060 🍴.
...
which according to the [PyPI Stats](https://pypistats.org/) have been downloaded 612,553 times over the past month.
...
1. [rytilahti/python-miio – Python library & console tool for controlling Xiaomi smart appliances](https://github.com/rytilahti/python-miio) (4,080 ⭐, 588 🍴)
2. [python-kasa/python-kasa – 🏠🤖 Python API for TP-Link smarthome products](https://github.com/python-kasa/python-kasa) (1,479 ⭐, 229 🍴)
...
In the past 371 days (since 17 August, 2024), I have submitted 129 pull requests on 8 different repositories, including:
* 90 pull requests to [python-kasa/python-kasa – 🏠🤖 Python API for TP-Link smarthome products](https://github.com/python-kasa/python-kasa) (1,479 ⭐, 229 🍴)
* 21 pull requests to [home-assistant/core – :house_with_garden: Open source home automation that puts local control and privacy first.](https://github.com/home-assistant/core) (80,882 ⭐, 34,768 🍴)
* 6 pull requests to [rytilahti/python-miio – Python library & console tool for controlling Xiaomi smart appliances](https://github.com/rytilahti/python-miio) (4,080 ⭐, 588 🍴)
* 4 pull requests to [home-assistant/home-assistant.io – :blue_book: Home Assistant User documentation](https://github.com/home-assistant/home-assistant.io) (7,173 ⭐, 7,838 🍴)
...
* 1 pull requests to [home-assistant/developers.home-assistant – Developers website for Home Assistant.](https://github.com/home-assistant/developers.home-assistant) (381 ⭐, 1,121 🍴)
</p></details>
...
During the previously mentioned time period, I have submitted 266 reviews to pull requests on 7 different repositories, including:
* 199 reviews to [python-kasa/python-kasa – 🏠🤖 Python API for TP-Link smarthome products](https://github.com/python-kasa/python-kasa) (1,479 ⭐, 229 🍴)
* 41 reviews to [home-assistant/core – :house_with_garden: Open source home automation that puts local control and privacy first.](https://github.com/home-assistant/core) (80,882 ⭐, 34,768 🍴)
* 12 reviews to [home-assistant/home-assistant.io – :blue_book: Home Assistant User documentation](https://github.com/home-assistant/home-assistant.io) (7,173 ⭐, 7,838 🍴)
* 8 reviews to [home-assistant/developers.home-assistant – Developers website for Home Assistant.](https://github.com/home-assistant/developers.home-assistant) (381 ⭐, 1,121 🍴)
* 3 reviews to [rytilahti/python-miio – Python library & console tool for controlling Xiaomi smart appliances](https://github.com/rytilahti/python-miio) (4,080 ⭐, 588 🍴)
