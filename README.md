...
and also written 5,634 issue comments here since 2013.
Since then, my projects have been honored with a total of 6,307 ⭐ and 1,056 🍴.
...
which according to the [PyPI Stats](https://pypistats.org/) have been downloaded 494,045 times over the past month.
...
1. [rytilahti/python-miio – Python library & console tool for controlling Xiaomi smart appliances](https://github.com/rytilahti/python-miio) (4,064 ⭐, 585 🍴)
2. [python-kasa/python-kasa – 🏠🤖 Python API for TP-Link smarthome products](https://github.com/python-kasa/python-kasa) (1,471 ⭐, 228 🍴)
...
In the past 371 days (since 20 July, 2024), I have submitted 131 pull requests on 9 different repositories, including:
* 92 pull requests to [python-kasa/python-kasa – 🏠🤖 Python API for TP-Link smarthome products](https://github.com/python-kasa/python-kasa) (1,471 ⭐, 228 🍴)
* 21 pull requests to [home-assistant/core – :house_with_garden: Open source home automation that puts local control and privacy first.](https://github.com/home-assistant/core) (80,397 ⭐, 34,463 🍴)
* 6 pull requests to [rytilahti/python-miio – Python library & console tool for controlling Xiaomi smart appliances](https://github.com/rytilahti/python-miio) (4,064 ⭐, 585 🍴)
* 4 pull requests to [home-assistant/home-assistant.io – :blue_book: Home Assistant User documentation](https://github.com/home-assistant/home-assistant.io) (7,086 ⭐, 7,804 🍴)
...
* 1 pull requests to [home-assistant/developers.home-assistant – Developers website for Home Assistant.](https://github.com/home-assistant/developers.home-assistant) (374 ⭐, 1,109 🍴)
</p></details>
...
During the previously mentioned time period, I have submitted 270 reviews to pull requests on 7 different repositories, including:
* 204 reviews to [python-kasa/python-kasa – 🏠🤖 Python API for TP-Link smarthome products](https://github.com/python-kasa/python-kasa) (1,471 ⭐, 228 🍴)
* 41 reviews to [home-assistant/core – :house_with_garden: Open source home automation that puts local control and privacy first.](https://github.com/home-assistant/core) (80,397 ⭐, 34,463 🍴)
* 12 reviews to [home-assistant/home-assistant.io – :blue_book: Home Assistant User documentation](https://github.com/home-assistant/home-assistant.io) (7,086 ⭐, 7,804 🍴)
* 8 reviews to [home-assistant/developers.home-assistant – Developers website for Home Assistant.](https://github.com/home-assistant/developers.home-assistant) (374 ⭐, 1,109 🍴)
* 2 reviews to [rytilahti/python-miio – Python library & console tool for controlling Xiaomi smart appliances](https://github.com/rytilahti/python-miio) (4,064 ⭐, 585 🍴)
